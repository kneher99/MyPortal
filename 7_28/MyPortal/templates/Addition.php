				...
				<div class="row">
					<div class="form-group" style="margin-left:15px;">
						...
						<form class="form-inline">
							<input type="text" id ="num1" class="input-small" ng-model="addend1" placeholder="Addend 1" disabled/>
							<label class="inline">
								<i class="ace-icon fa fa-plus blue"></i>
							</label>			
							<input type="text" id="num2" class="input-small" ng-model="addend2" placeholder="Addend 2" disabled/>
