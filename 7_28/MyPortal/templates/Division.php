				...
				<div class="row">
					<div class="form-group" style="margin-left:15px;">
						...
						<form class="form-inline">
							<input type="text" id ="num1" class="input-small" ng-model="dividend" placeholder="Dividend" disabled/>
							<label class="inline">
								<i class="ace-icon fa fa-italic blue"></i>
							</label>			
							<input type="text" id="num2" class="input-small" ng-model="divisor" placeholder="Divisor" disabled/>
