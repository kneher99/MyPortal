...
<div class="page-content" ng-app="myProfileApp">
		...
		<div class="row">
			<div class="col-xs-9" ng-controller="profileController" ng-init="init('<?php echo $myUserID?>')">

				<!-- PAGE CONTENT BEGINS -->
				<form class="form-horizontal" role="form" action="updateProfile.php" id="profileForm" enctype="multipart/form-data" name="profileForm" method="post">	

					<input type="hidden" name="hdnUserID" value="<?php echo $myUserID?>">
					...
					<div class="form-group">
						<div class="col-xs-6">
							...
							<input type="file" id="id-input-file-2" data-bind-file="" data-ng-model="theFile" autocomplete="off" name="fileAvatar"/>
						</div>
					</div>
					...
					<div class="col-xs-6 col-sm-3 center">
						<div>
							<span>
									<img id="myAvatar" alt="{{fName}}'s Avatar" ng-src="{{avatar}}" on-error-src="{{noImage}}"/></img>
							</span>						
						...
						<div class="clearfix form-actions">
							<div class="col-xs-12 col-sm-3 center">
									<button class="btn btn-info" type="button" id="subButton">
